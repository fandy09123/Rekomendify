...
import { F as Mail, et as Copy, n as X, p as ShieldCheck, st as Check, y as Search } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { n as AnimatePresence, t as motion } from "../_libs/framer-motion.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/privacy-policy-modal-0lwoT88L.js
...
*/
var KEY = "rekomendify:onboarding:v1";
...
function isOnboardingBlockedPath(pathname) {
	return pathname.startsWith("/admin") || pathname.startsWith("/auth") || pathname.startsWith("/reset-password") || pathname.startsWith("/q/") || pathname.endsWith("/scan") || pathname === "/privasi";
}
var PRIVACY_POLICY = {
	...
	sections: [
		...
		},
		{
			...
			paragraphs: ["Pengelola resmi dan penanggung jawab perlindungan data Rekomendify dapat dihubungi melalui identitas berikut:"],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["Kami berkomitmen penuh menjalankan operasional aplikasi berdasarkan prinsip-prinsip perlindungan data berikut:"],
			subsections: [
				{
		...
		},
		{
			...
			paragraphs: ["Jenis informasi yang diproses bergantung pada fitur yang digunakan. Tidak semua pengguna memberikan atau menggunakan seluruh jenis informasi."],
			subsections: [{
				subtitle: "4.1 Informasi Akun",
				paragraphs: ["Aplikasi Rekomendify bagi publik dapat diakses tanpa pendaftaran akun. Namun untuk fitur administrasi/pengelola wilayah, Rekomendify dapat memproses informasi seperti:"],
				bullets: [
		...
		},
		{
			...
			paragraphs: ["Rekomendify dapat menggunakan lokasi perangkat untuk fitur seperti 'Terdekat', pencarian tempat di sekitar pengguna, atau fungsi lain yang secara langsung membutuhkan posisi pengguna."],
			bullets: [
		...
		},
		{
			...
			number: 6,
			title: "KAMERA",
			paragraphs: ["Rekomendify dapat meminta akses kamera khusus untuk fitur Scan QR."],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["Untuk Web Push, browser/perangkat memberikan informasi teknis subscription yang diperlukan Push Service untuk mengirimkan notifikasi."],
			bullets: [
			...
			subsections: [{
				...
				paragraphs: ["Data ini digunakan semata-mata untuk mengidentifikasi tujuan pengiriman notifikasi web dan menangani subscription yang sudah kadaluarsa. Data subscription tidak digunakan untuk mengakses isi perangkat."]
			}]
		},
		{
			id: "9",
			...
			paragraphs: ["Rekomendify menyediakan fitur kotak masuk/riwayat notifikasi lokal.", "Informasi seperti judul notifikasi, isi pesan, waktu penerimaan, tautan tujuan, dan status baca disimpan di penyimpanan lokal perangkat (LocalStorage/IndexedDB) agar pengguna dapat melihat kembali pesan walau sedang offline."]
		},
		{
			id: "10",
			number: 10,
			title: "INFORMASI TEKNIS DAN PENGGUNAAN LAYANAN",
			paragraphs: ["Sistem dapat memproses informasi teknis yang diperlukan untuk menjalankan aplikasi, menjaga keamanan, memantau error, dan meningkatkan performa."],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["Rekomendify mencatat aktivitas penggunaan secara anonim dan agregat untuk mengetahui statistik kunjungan tempat/wilayah.", "Data yang dicatat meliputi: halaman yang dibuka, sumber akses (QR atau tautan langsung), dan tindakan tombol (membuka WhatsApp, Google Maps, atau menyimpan tempat). Catatan ini tidak memuat nama, nomor HP, atau titik lokasi pengguna."]
		},
		{
			id: "12",
			number: 12,
			title: "DATA YANG TIDAK KAMI MINTA TANPA KEBUTUHAN",
			paragraphs: ["Rekomendify tidak dirancang untuk meminta akses ke:"],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["Pengguna memiliki kendali penuh atas izin Notifikasi, Lokasi, dan Kamera.", "Menolak izin dapat menyebabkan fitur terkait tidak berjalan maksimal (misalnya Scan QR memerlukan kamera), namun layanan utama Rekomendify tetap dapat digunakan."]
		},
		{
			id: "14",
			number: 14,
			title: "PENGUNGKAPAN SEBELUM PERMINTAAN IZIN",
			paragraphs: ["Rekomendify memberikan penjelasan peruntukan izin sebelum meminta persetujuan pada browser atau sistem operasi Android.", "Penutupan dialog penjelasan tanpa memilih tindakan persetujuan tidak dianggap sebagai persetujuan izin."]
		},
		{
			id: "15",
			number: 15,
			title: "PIHAK KETIGA DAN PENYEDIA INFRASTRUKTUR",
			paragraphs: ["Untuk menyelenggarakan layanan, Rekomendify menggunakan penyedia infrastruktur terpercaya:"],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["Kami tidak menjual data pribadi pengguna.", "Data hanya diproses oleh penyedia infrastruktur teknis untuk keperluan penyediaan layanan, atau apabila diwajibkan oleh hukum dan hukum yang berlaku."]
		},
		{
			id: "17",
			number: 17,
			title: "KEAMANAN DATA",
			paragraphs: ["Kami menerapkan pengamanan teknis seperti penggunaan protokol HTTPS (SSL/TLS), kontrol akses terenkripsi, enkripsi VAPID key server-side, serta perlindungan database di Supabase."]
		},
		{
			id: "18",
			number: 18,
			title: "RETENSI DATA",
			paragraphs: ["Data akun admin disimpan selama akun aktif. Push subscription dipertahankan hingga pengguna berhenti berlangganan atau endpoint dinyatakan tidak valid oleh Push Service. Riwayat notifikasi di perangkat dapat dihapus kapan saja oleh pengguna."]
		},
		{
			id: "19",
			number: 19,
			title: "PENGELOLAAN DAN PENGHAPUSAN AKUN ADMIN / MITRA",
			paragraphs: ["Aplikasi ini tidak memiliki pendaftaran mandiri publik (non-account-based service untuk pengguna umum). Akses akun hanya diterbitkan terbatas untuk Admin Wilayah / Partner Resmi (BUMDes/Perangkat Desa) berdasarkan Perjanjian Kerja Sama (PKS).", "Bagi Admin/Mitra yang ingin mengajukan penghapusan akun beserta data operasional, permohonan resmi dapat dikirim melalui email ke alfianfendi2@gmail.com dengan subjek: 'Permohonan Penghapusan Akun Admin - [Nama Desa/Wilayah]'. Data kredensial akan dihapus/dianonimkan dalam waktu maksimal 30 hari kerja."]
		},
		{
			id: "20",
			number: 20,
			title: "PENCABUTAN IZIN",
			paragraphs: ["Izin perangkat dapat dicabut kapan saja via pengaturan browser (Setelan situs → Rekomendify) atau Android (Setelan → Aplikasi → Rekomendify → Izin)."]
		},
		{
			id: "21",
			number: 21,
			title: "COOKIE, CACHE, STORAGE, DAN DATA LOKAL",
			paragraphs: ["Rekomendify menggunakan Cache Storage, IndexedDB, dan LocalStorage untuk mempercepat aplikasi, mendukung mode PWA/offline, serta menyimpan favorit dan riwayat notifikasi lokal."]
		},
		{
			id: "22",
			number: 22,
			title: "WEBVIEW PADA APLIKASI ANDROID",
			paragraphs: ["Aplikasi Android Rekomendify menggunakan Capacitor App Shell untuk menampilkan web Rekomendify dalam WebView. Konten dipembarui langsung dari server tanpa harus selalu menginstal ulang APK."]
		},
		{
			id: "23",
			number: 23,
			title: "LINK EKSTERNAL",
			paragraphs: ["Rekomendify menyediakan tautan luar seperti WhatsApp, Google Maps, telepon, dan email. Saat berpindah ke aplikasi pihak ketiga, kebijakan privasi masing-masing penyedia layanan tersebut berlaku."]
		},
		{
			id: "24",
			number: 24,
			title: "DATA ANAK",
			paragraphs: ["Rekomendify adalah layanan pemandu informasi umum dan tidak ditujukan khusus untuk anak-anak. Kami tidak meminta data anak secara sengaja."]
		},
		{
			id: "25",
			number: 25,
			title: "PRIVASI DALAM KONTEKS DESA/WILAYAH",
			paragraphs: ["Informasi lokasi usaha, UMKM, fasilitas, dan kegiatan wilayah yang ditampilkan adalah informasi publik dan bukan merupakan data pribadi pengguna."]
		},
		{
			id: "26",
			number: 26,
			title: "PERUBAHAN KEBIJAKAN PRIVASI",
			paragraphs: ["Kebijakan Privasi dapat diperbarui sewaktu-waktu mengikuti perkembangan fitur, arsitektur, atau regulasi hukum. Versi terbaru selalu dipublikasikan di https://www.rekomendify.com/privasi."]
		},
		{
			id: "27",
			number: 27,
			title: "HAK PENGGUNA",
			paragraphs: ["Pengguna berhak mengetahui pemrosesan data, meminta informasi, memperbaiki data, serta mengajukan pertanyaan terkait privasi melalui email alfianfendi2@gmail.com."]
		},
		{
			id: "28",
			number: 28,
			title: "KEWAJIBAN PENGGUNA",
			paragraphs: ["Pengguna admin bertanggung jawab menjaga keamanan kredensial akun dan tidak menggunakan Rekomendify untuk tindakan melanggar hukum."]
		},
		{
			id: "29",
			number: 29,
			title: "KONTAK TERKAIT PRIVASI",
			paragraphs: ["Untuk pertanyaan atau keluhan privasi, silakan hubungi:"],
			bullets: [
		...
		},
		{
			...
			paragraphs: ["Kebijakan Privasi ini konsisten dengan pernyataan Data Safety pada Google Play Console. Segala pemrosesan data oleh SDK/library internal telah didokumentasikan dengan akurat."]
		},
		{
			id: "31",
			number: 31,
			title: "KETENTUAN AKHIR",
			paragraphs: ["Dengan menggunakan Rekomendify, Anda memahami dan menyetujui prinsip minimisasi data, transparansi, dan kontrol izin yang berlaku.", "Dokumen ini merupakan Kebijakan Privasi resmi Rekomendify."]
		}
	]
};
function PrivacyPolicyModal({ open, onOpenChange, initialSectionId }) {
	const [searchQuery, setSearchQuery] = (0, import_react.useState)("");
	const [activeSection, setActiveSection] = (0, import_react.useState)(initialSectionId ?? null);
	...
	const filteredSections = (0, import_react.useMemo)(() => {
		...
		return PRIVACY_POLICY.sections.filter((sec) => {
			...
			const inSubsections = sec.subsections?.some((sub) => sub.subtitle.toLowerCase().includes(q) || sub.paragraphs?.some((p) => p.toLowerCase().includes(q)));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "fixed inset-0 z-[100] flex items-end justify-center bg-black/60 backdrop-blur-xs sm:items-center sm:p-4",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "sticky top-0 z-20 flex flex-col border-b border-border bg-background/95 px-5 py-4 backdrop-blur-md",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center justify-between gap-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2.5 min-w-0",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "grid size-9 shrink-0 place-items-center rounded-xl bg-primary/12 text-primary",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "size-5" })
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "min-w-0",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									className: "font-display text-lg sm:text-xl truncate leading-tight",
									children: "Kebijakan Privasi Rekomendify"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: "text-xs text-muted-foreground",
									children: ["Terakhir diperbarui: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex-1 overflow-y-auto px-5 py-4 space-y-6 scrollbar-thin",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-2xl border border-primary/20 bg-primary/5 p-4 text-xs leading-relaxed text-foreground",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-semibold text-primary mb-1",
							children: "📌 Ringkasan Prinsip Privasi:"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "list-disc pl-4 space-y-1 text-muted-foreground",
							children: PRIVACY_POLICY.principles.map((pr, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: pr }, idx))
						})]
					}), filteredSections.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "py-12 text-center text-sm text-muted-foreground",
						children: [
							"Tidak ada pasal yang cocok dengan pencarian “",
							searchQuery,
							"”."
						]
					}) : filteredSections.map((sec) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
						id: `privacy-sec-${sec.id}`,
						className: `rounded-2xl border p-4 sm:p-5 transition-colors ${activeSection === sec.id ? "border-primary/40 bg-primary/5" : "border-border bg-card"}`,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
								className: "font-display text-base sm:text-lg font-semibold text-foreground flex items-center gap-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "shrink-0 grid size-6 place-items-center rounded-lg bg-accent/15 text-accent text-xs font-bold",
									children: sec.number
								}), sec.title]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-3 space-y-2 text-sm leading-relaxed text-muted-foreground",
								children: sec.paragraphs.map((p, pIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: p }, pIdx))
							}),
							sec.bullets && sec.bullets.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
								className: "mt-3 space-y-1.5 list-disc pl-5 text-sm text-muted-foreground",
								children: sec.bullets.map((b, bIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: b }, bIdx))
							}),
							sec.subsections && sec.subsections.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-4 space-y-3 pl-2 border-l-2 border-border",
								children: sec.subsections.map((sub, subIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "space-y-1",
									children: [
										...
										sub.paragraphs?.map((sp, spIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-sm text-muted-foreground leading-relaxed",
											children: sp
										}, spIdx)),
										sub.bullets && sub.bullets.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
											className: "list-disc pl-4 text-xs text-muted-foreground space-y-1",
											children: sub.bullets.map((sb, sbIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: sb }, sbIdx))
										})
									]
								}, subIdx))
							})
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "sticky bottom-0 z-20 border-t border-border bg-background/95 p-4 backdrop-blur-md flex flex-wrap items-center justify-between gap-2.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [copied ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-3.5 text-primary" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, { className: "size-3.5" }), copied ? "Tersalin!" : "Salin Tautan"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							href: `mailto:${PRIVACY_POLICY.contact.email}`,
							className: "inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-3.5 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mail, { className: "size-3.5 text-muted-foreground" }), "Kontak Email"]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						onClick: () => onOpenChange(false),
...
//#endregion
export { markOnboardingSeen as a, isOnboardingBlockedPath as i, PrivacyPolicyModal as n, resetOnboarding as o, hasSeenOnboarding as r, PRIVACY_POLICY as t };
